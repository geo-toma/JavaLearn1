...
public class Objet_class {
	...
	public void testWithStringClass() {
		...
		Class<String> c = String.class; // une deuxieme maniere
	...
	public void testWithPaireClass() {
		...
		try {
			...
			Object o1 = ct.newInstance(new Object[] {"valeur 1", "valeur 2"});
			
			Method m = c.getMethod("toString");//recupere la methode toString 
			//si la methode toString avait des parametre on les met a la suite des argument de getMethode ("toString", null) dans ce cas
			
			System.out.println("----------------------------------------------------------------------------------");
			System.out.println("la methode "+m.getName()+" appliquer sur l'objet o : "+m.invoke(o));
			System.out.println("la methode "+m.getName()+" appliquer sur l'objet o1 : "+m.invoke(o1));
			// invoke execute la methode m appeler par l'objet passer en parametre
			//invoke prend aussi les autres parametres en arguments si la methode m en a
